...
\sectionhead{Setup}
\footnotesize
120 synthetic benchmarks varying rule count, size, and negation. ILASP baseline runs search using an ASP meta encoding with 7 minute timeout.
...
\vspace{0.10cm}
{\scriptsize Outputs averaged 5 literals vs 22 or 33, more stratified.\par}
{\scriptsize Strong LAMP models solved all 3 ILASP timeout benchmarks.\par}
