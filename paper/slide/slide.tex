...
{\setbeamercolor{background canvas}{bg=potsdamblue}
\begin{frame}[plain]
\centering
\vspace{0.6cm}
{\color{white}\bfseries\Huge LAMP\par}
\vspace{0.25cm}
{\color{white}\Large ASP Rule Induction and Optimization with LLMs\par}
\vspace{0.9cm}
{\color{white}\large David Bunker\par}
\vspace{0.15cm}
{\color{white}\normalsize University of Potsdam\par}
\end{frame}
}
...
\begin{tabular}{@{}lrr@{}}
\toprule
\textbf{System} & \textbf{Final acc.} & \textbf{Failures} \\
\midrule
\textit{gpt-5-mini}      & 99.2\% & 1 \\
\textit{gpt-oss:20b}     & 98.3\% & 2 \\
\textit{qwen3-coder:30b} & 64.2\% & 43 \\
ILASP                    & 97.5\% & 3 \\
\bottomrule
\end{tabular}
