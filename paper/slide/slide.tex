...
\sectionhead{Setup}
\footnotesize
120 synthetic benchmarks of varying complexity. ILASP baseline runs search using ASP meta encoding with 7 minute timeout.
...
\vspace{0.10cm}
{\scriptsize Outputs averaged 5 literals from 22 or 33 originals, more stratified.\par}
